...
#ifdef __linux__
#define _S21_NERR_ 133
#define _UNKN_ER_ "Unknown error "
#define _ERROR_S21_ { \
"Success", \
...
int s21_sprintf_f(char **str, long double d, int width, int precision, int g,
                  int flag, int sign, int zero, int space, int sharp);
int s21_sprintf_u(char **str, unsigned long long int i, int base, int width,
                  int precision, int flag, int zero, int sharp, int char_case,
                  int length);
int integer_helper(char **str, long long int i, int base, int width,
                   int precision, int flag, int sign, int zero, int space);
int unsigned_integer_helper(char **str, unsigned long long int i, int base,
                            int width, int precision, int flag, int sign,
                            int zero, int space, int sharp, int char_case);
